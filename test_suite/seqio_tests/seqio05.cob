...
* PROGRAM WRITES AFTER FILE IS CLOSED
 ...
 FILE-CONTROL.
     SELECT GOZOUT ASSIGN TO "foobar.dat" 
 ...
 0000-PROGRAM-ENTRY.
      ...
      PERFORM C100-EXTRA-WRITE THRU C100-EXIT.
 ...
 E000-SUMMARY.
      DISPLAY "SW24:(" WS-TEST-COUNTER "):(0006):"
