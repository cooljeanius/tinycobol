 ...
 FILE-CONTROL.
  SELECT ARQ	  ASSIGN TO "TEST08Raw.dat" 
      ...
      FILE STATUS  IS FS.
  SELECT OUT-REC ASSIGN TO "TEST08gSorted.dat"
      ORGANIZATION IS SEQUENTIAL    
      ACCESS MODE IS SEQUENTIAL
      FILE STATUS IS FS.
  SELECT OUT-REC1 ASSIGN TO "TEST08gSorted1.dat"
      ORGANIZATION IS SEQUENTIAL    
      ACCESS MODE IS SEQUENTIAL
      FILE STATUS IS FS.

  SELECT SORT-REC ASSIGN TO "TEST08gSort.dat".
