...
*      DISPLAY "LENGTH : RECORD"
 ...
 A200-READ-LOOP.
   EVALUATE PHONE-RECORD-TYPE
      WHEN 'A' 
*       DISPLAY "RECORD-LENGTH=60 :" PHONE-RECORD-A ":"
       ADD 1 TO W01-READ-CNT-A
      WHEN 'B'  
*       DISPLAY "RECORD-LENGTH=60 :" PHONE-RECORD-B ":"
       ADD 1 TO W01-READ-CNT-B
     WHEN  'C'
*       DISPLAY "RECORD-LENGTH=60 :" PHONE-RECORD-C ":"
...
*   DISPLAY "BEFORE READ: FILE W01-STATUS=" W01-STATUS
 ...
 A100-CREATE-FILE.       
   MOVE ALL "A" TO PHONE-RECORD-A.
   WRITE PHONE-RECORD-A.
   IF W01-STATUS NOT = "00"
   THEN
      DISPLAY "ERROR IN WRITING PHONE-RECORD-A W01-STATUS=" W01-STATUS
   ELSE
      ADD 1 TO W01-WRITE-CNT-A
   END-IF.    

   MOVE ALL "B" TO PHONE-RECORD-B.
   WRITE PHONE-RECORD-B.
   IF W01-STATUS NOT = "00"
   THEN
      DISPLAY "ERROR IN WRITING PHONE-RECORD-B W01-STATUS=" W01-STATUS
   ELSE
      ADD 1 TO W01-WRITE-CNT-B
   END-IF.    

   MOVE ALL "C" TO PHONE-RECORD-C.
   WRITE PHONE-RECORD-C.
   IF W01-STATUS NOT = "00"
   THEN
      DISPLAY "ERROR IN WRITING PHONE-RECORD-C W01-STATUS=" W01-STATUS
   ELSE
