...
ac_unique_file="compiler/htcoboly.h"
...
ac_subst_vars='SHELL PATH_SEPARATOR PACKAGE_NAME PACKAGE_TARNAME PACKAGE_VERSION PACKAGE_STRING PACKAGE_BUGREPORT exec_prefix prefix program_transform_name bindir sbindir libexecdir datadir sysconfdir sharedstatedir localstatedir libdir includedir oldincludedir infodir mandir build_alias host_alias target_alias DEFS ECHO_C ECHO_N ECHO_T LIBS build build_cpu build_vendor build_os host host_cpu host_vendor host_os target target_cpu target_vendor target_os CC AS INSTALL_PROGRAM INSTALL_SCRIPT INSTALL_DATA LN_S SET_MAKE RANLIB ac_ct_RANLIB AR LEX YACC expand_cmd_path CFLAGS LDFLAGS CPPFLAGS ac_ct_CC EXEEXT OBJEXT CPP EGREP LIBOBJS ALLOCA CCX COB INCLUDES CCXFLAGS ACXFLAGS exeext tcob_default cobcpy_default yacc_prefix_compiler copybook_path tcob_docdir os_platform TCOB_MAJOR_VERSION TCOB_MINOR_VERSION TCOB_PATCH_LEVEL TCOB_VERSION TCOB_RELEASE_DATE tcob_version prefix_local drive_prefix TCOBRUN_MAJOR_VERSION TCOBRUN_MINOR_VERSION TCOBRUN_PATCH_LEVEL TCOBRUN_VERSION TCOBRUN_RELEASE_DATE tcob_libs_opt tcob_libs_install_opt tcob_libs_uninstall_opt tcob_cobrun_build_opt tcob_cobrun_name1_opt tcob_cobrun_name2_opt tcob_manfiles tcob_htmlfiles tcob_textfiles tcob_intman tcob_inthtml tcob_inttext tcob_cobf2f_dir tcob_cobf2f_dir1 tcob_cobf2f_man tcob_cobf2f_html tcob_cobf2f_text tcob_cobf2f_intman tcob_cobf2f_inthtml tcob_cobf2f_inttext tcob_math_functions tcob_ld_args_htcobol tcob_ld_args_m tcob_ld_args_db tcob_ld_args_isam tcob_ld_args_dl tcob_ld_args_curses tcob_ld_args_readline tcob_ld_paths_default tcob_ld_args_default tcob_ld_args_defaults asx_cmd ccx_cmd ranlibx_cmd arx_cmd tcob_lang LTLIBOBJS'
ac_subst_files=''
...
#
          ...
          ac_config_headers="$ac_config_headers htconfig.h"
...
{ echo "$as_me:$LINENO: build version is $TCOB_VERSION" >&5
echo "$as_me: build version is $TCOB_VERSION" >&6;}
...
# Check whether --with-with-C-compiler or --without-with-C-compiler was given.
if test "${with_with_C_compiler+set}" = set; then
  withval="$with_with_C_compiler"
...
#
#AC_PROG_CC
# Extract the first word of ""$c_compiler"", so it can be a program name with args.
set dummy "$c_compiler"; ac_word=$2
...
do
  ...
  test -z "$ac_cv_prog_CC" && ac_cv_prog_CC="no"
fi
fi
CC=$ac_cv_prog_CC
if test -n "$CC"; then
...
if test "${CC}" = "no" ; then
   { { echo "$as_me:$LINENO: error: C compiler not found... aborting" >&5
echo "$as_me: error: C compiler not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
fi
...
# Check whether --with-with-lex or --without-with-lex was given.
if test "${with_with_lex+set}" = set; then
  withval="$with_with_lex"
...
# Extract the first word of ""$lex_name"", so it can be a program name with args.
set dummy "$lex_name"; ac_word=$2
echo "$as_me:$LINENO: checking for $ac_word" >&5
echo $ECHO_N "checking for $ac_word... $ECHO_C" >&6
...
do
  ...
  test -z "$ac_cv_prog_LEX" && ac_cv_prog_LEX="no"
fi
fi
LEX=$ac_cv_prog_LEX
if test -n "$LEX"; then
...
if test "${LEX}" = "no" ; then
   { { echo "$as_me:$LINENO: error: required program not found... aborting" >&5
echo "$as_me: error: required program not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
#else
#  LEX=${FLEX}
fi
...
# Check whether --with-with-yacc or --without-with-yacc was given.
if test "${with_with_yacc+set}" = set; then
  withval="$with_with_yacc"
...
# Extract the first word of ""$yacc_name"", so it can be a program name with args.
set dummy "$yacc_name"; ac_word=$2
echo "$as_me:$LINENO: checking for $ac_word" >&5
echo $ECHO_N "checking for $ac_word... $ECHO_C" >&6
...
if test "${YACC}" = "no" ; then
   { { echo "$as_me:$LINENO: error: Compiler compiler (i.e. Berkeley's YACC version 1.9.3 or Bison) not found... aborting" >&5
echo "$as_me: error: Compiler compiler (i.e. Berkeley's YACC version 1.9.3 or Bison) not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
else
...
# Extract the first word of "expand", so it can be a program name with args.
set dummy expand; ac_word=$2
echo "$as_me:$LINENO: checking for $ac_word" >&5
echo $ECHO_N "checking for $ac_word... $ECHO_C" >&6
if test "${ac_cv_path_expand_cmd_path+set}" = set; then
  echo $ECHO_N "(cached) $ECHO_C" >&6
else
  case $expand_cmd_path in
  [\\/]* | ?:[\\/]*)
  ac_cv_path_expand_cmd_path="$expand_cmd_path" # Let the user override the test with a path.
  ;;
  *)
  as_save_IFS=$IFS; IFS=$PATH_SEPARATOR
for as_dir in $PATH
do
  ...
  for ac_exec_ext in '' $ac_executable_extensions; do
  if $as_executable_p "$as_dir/$ac_word$ac_exec_ext"; then
    ac_cv_path_expand_cmd_path="$as_dir/$ac_word$ac_exec_ext"
    echo "$as_me:$LINENO: found $as_dir/$ac_word$ac_exec_ext" >&5
    break 2
  fi
done
  ...
  test -z "$ac_cv_path_expand_cmd_path" && ac_cv_path_expand_cmd_path="no"
  ;;
esac
fi
expand_cmd_path=$ac_cv_path_expand_cmd_path

if test -n "$expand_cmd_path"; then
  echo "$as_me:$LINENO: result: $expand_cmd_path" >&5
echo "${ECHO_T}$expand_cmd_path" >&6
else
  echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6
fi
...
for ac_header in stdio.h alloca.h errno.h fcntl.h limits.h sys/time.h \
		 unistd.h malloc.h stdlib.h string.h strings.h utime.h \
		 ctype.h sys/stat.h sys/types.h dlfcn.h getopt.h
do
as_ac_Header=`echo "ac_cv_header_$ac_header" | $as_tr_sh`
if eval "test \"\${$as_ac_Header+set}\" = set"; then
  echo "$as_me:$LINENO: checking for $ac_header" >&5
...
for ac_func in memmove memset strcspn strdup strerror strspn putenv fcntl
do
as_ac_var=`echo "ac_cv_func_$ac_func" | $as_tr_sh`
echo "$as_me:$LINENO: checking for $ac_func" >&5
echo $ECHO_N "checking for $ac_func... $ECHO_C" >&6
...
# Check whether --enable-debug-all or --disable-debug-all was given.
if test "${enable_debug_all+set}" = set; then
  enableval="$enable_debug_all"
  cat >>confdefs.h <<\_ACEOF
#define DEBUG_COMPILER 1
_ACEOF

	cat >>confdefs.h <<\_ACEOF
#define PICTURE_TESTING 1
_ACEOF
...
# Evaluate debugging options.
# Check whether --enable-debug-comp or --disable-debug-comp was given.
if test "${enable_debug_comp+set}" = set; then
  enableval="$enable_debug_comp"
  cat >>confdefs.h <<\_ACEOF
#define DEBUG_COMPILER 1
_ACEOF
...
# Check whether --enable-debug-compiler or --disable-debug-compiler was given.
if test "${enable_debug_compiler+set}" = set; then
  enableval="$enable_debug_compiler"
  cat >>confdefs.h <<\_ACEOF
#define DEBUG_COMPILER 1
_ACEOF
...
# Check whether --enable-debug-scanner or --disable-debug-scanner was given.
if test "${enable_debug_scanner+set}" = set; then
  enableval="$enable_debug_scanner"
  cat >>confdefs.h <<\_ACEOF
#define DEBUG_SCANNER 1
_ACEOF
...
# Check whether --enable-debug-rts or --disable-debug-rts was given.
if test "${enable_debug_rts+set}" = set; then
  enableval="$enable_debug_rts"
  cat >>confdefs.h <<\_ACEOF
#define DEBUG_RTS 1
_ACEOF
...
# Check whether --enable-debug-rts-move or --disable-debug-rts-move was given.
if test "${enable_debug_rts_move+set}" = set; then
  enableval="$enable_debug_rts_move"
  cat >>confdefs.h <<\_ACEOF
#define DEBUG_MOVE_RTS 1
_ACEOF
...
# Check whether --enable-debug-pp or --disable-debug-pp was given.
if test "${enable_debug_pp+set}" = set; then
  enableval="$enable_debug_pp"
  cat >>confdefs.h <<\_ACEOF
...
#mf_compatibility="0"
# Check whether --enable-mfcomp or --disable-mfcomp was given.
if test "${enable_mfcomp+set}" = set; then
  enableval="$enable_mfcomp"
  cat >>confdefs.h <<\_ACEOF
...
# Check whether --enable-test-mode or --disable-test-mode was given.
if test "${enable_test_mode+set}" = set; then
  enableval="$enable_test_mode"
...
case "$enable_shared" in
  yes)
   ...
   no)
     ...
     ;;
    *)
     { { echo "$as_me:$LINENO: error: Invalid build shared libraries option... aborting" >&5
echo "$as_me: error: Invalid build shared libraries option... aborting" >&2;}
   { (exit 1); exit 1; }; }
     ;;
esac
#
...
case "$enable_static" in
  yes)
   ...
   no)
     ...
     ;;
    *)
     { { echo "$as_me:$LINENO: error: Invalid build static libraries option... aborting" >&5
echo "$as_me: error: Invalid build static libraries option... aborting" >&2;}
   { (exit 1); exit 1; }; }
     ;;
esac
#
...
if test "$enable_static" = "no" && test "$enable_shared" = "no"; then
   { { echo "$as_me:$LINENO: error: Conflicting options for shared and static libraries build... aborting" >&5
echo "$as_me: error: Conflicting options for shared and static libraries build... aborting" >&2;}
   { (exit 1); exit 1; }; }
fi
...
as_ac_Lib=`echo "ac_cv_lib_$tcob_ld_args_m''_asin" | $as_tr_sh`
echo "$as_me:$LINENO: checking for asin in -l$tcob_ld_args_m" >&5
echo $ECHO_N "checking for asin in -l$tcob_ld_args_m... $ECHO_C" >&6
if eval "test \"\${$as_ac_Lib+set}\" = set"; then
  echo $ECHO_N "(cached) $ECHO_C" >&6
else
  ac_check_lib_save_LIBS=$LIBS
LIBS="-l$tcob_ld_args_m  $LIBS"
cat >conftest.$ac_ext <<_ACEOF
/* confdefs.h.  */
_ACEOF
cat confdefs.h >>conftest.$ac_ext
...
if test `eval echo '${'$as_ac_Lib'}'` = yes; then
  ...
  { { echo "$as_me:$LINENO: error: Math library \"$tcob_ld_args_m\" is required to create COBOL executable" >&5
echo "$as_me: error: Math library \"$tcob_ld_args_m\" is required to create COBOL executable" >&2;}
   { (exit 1); exit 1; }; }
...
if test x"$os_platform" = "x" && test "${define_dl}" = "no"; then
   { { echo "$as_me:$LINENO: error: dynamic loader not found... aborting" >&5
echo "$as_me: error: dynamic loader not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
fi
...
for ac_header in ${curses_header}
do
as_ac_Header=`echo "ac_cv_header_$ac_header" | $as_tr_sh`
if eval "test \"\${$as_ac_Header+set}\" = set"; then
  echo "$as_me:$LINENO: checking for $ac_header" >&5
...
_ACEOF
   ...
   { { echo "$as_me:$LINENO: error: header \"${curses_header}\" not found... aborting" >&5
echo "$as_me: error: header \"${curses_header}\" not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
...
as_ac_Lib=`echo "ac_cv_lib_${curses_library}''_addch" | $as_tr_sh`
echo "$as_me:$LINENO: checking for addch in -l${curses_library}" >&5
echo $ECHO_N "checking for addch in -l${curses_library}... $ECHO_C" >&6
if eval "test \"\${$as_ac_Lib+set}\" = set"; then
  echo $ECHO_N "(cached) $ECHO_C" >&6
else
  ac_check_lib_save_LIBS=$LIBS
LIBS="-l${curses_library}  $LIBS"
cat >conftest.$ac_ext <<_ACEOF
/* confdefs.h.  */
_ACEOF
cat confdefs.h >>conftest.$ac_ext
...
if test `eval echo '${'$as_ac_Lib'}'` = yes; then
  ...
  #             M_LIBS="$M_LIBS",
             { { echo "$as_me:$LINENO: error: curses library is required by run-time... aborting" >&5
echo "$as_me: error: curses library is required by run-time... aborting" >&2;}
   { (exit 1); exit 1; }; }
...
if test "${define_with_curses}" = "yes" ; then
  echo "$as_me:$LINENO: checking for color_set in -l${curses_library}" >&5
echo $ECHO_N "checking for color_set in -l${curses_library}... $ECHO_C" >&6
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; curses_with_color_set="yes"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5
...
_ACEOF
      ...
      { { echo "$as_me:$LINENO: error: header readline.h for readline library not found... aborting" >&5
echo "$as_me: error: header readline.h for readline library not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
...
echo "$as_me:$LINENO: checking for rl_tilde_expand in -lreadline" >&5
echo $ECHO_N "checking for rl_tilde_expand in -lreadline... $ECHO_C" >&6
if test "${ac_cv_lib_readline_rl_tilde_expand+set}" = set; then
  echo $ECHO_N "(cached) $ECHO_C" >&6
else
  ac_check_lib_save_LIBS=$LIBS
LIBS="-lreadline  $LIBS"
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  echo "$as_me:$LINENO: \$? = $ac_status" >&5
  (exit $ac_status); }; }; then
  ac_cv_lib_readline_rl_tilde_expand=yes
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5

ac_cv_lib_readline_rl_tilde_expand=no
fi
rm -f conftest.err conftest.$ac_objext \
      conftest$ac_exeext conftest.$ac_ext
LIBS=$ac_check_lib_save_LIBS
fi
echo "$as_me:$LINENO: result: $ac_cv_lib_readline_rl_tilde_expand" >&5
echo "${ECHO_T}$ac_cv_lib_readline_rl_tilde_expand" >&6
if test $ac_cv_lib_readline_rl_tilde_expand = yes; then
  cat >>confdefs.h <<_ACEOF
...
_ACEOF
  ...
  LIBS="-lreadline $LIBS"
      ...
      { { echo "$as_me:$LINENO: error: readline library not found... aborting" >&5
echo "$as_me: error: readline library not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
...
_ACEOF
    ...
    { { echo "$as_me:$LINENO: error: header vbisam.h for VB-ISAM library vbisam not found... aborting" >&5
echo "$as_me: error: header vbisam.h for VB-ISAM library vbisam not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
...
echo "$as_me:$LINENO: checking for isopen in -lvbisam" >&5
echo $ECHO_N "checking for isopen in -lvbisam... $ECHO_C" >&6
if test "${ac_cv_lib_vbisam_isopen+set}" = set; then
  echo $ECHO_N "(cached) $ECHO_C" >&6
else
  ac_check_lib_save_LIBS=$LIBS
LIBS="-lvbisam  $LIBS"
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  echo "$as_me:$LINENO: \$? = $ac_status" >&5
  (exit $ac_status); }; }; then
  ac_cv_lib_vbisam_isopen=yes
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5

ac_cv_lib_vbisam_isopen=no
fi
rm -f conftest.err conftest.$ac_objext \
      conftest$ac_exeext conftest.$ac_ext
LIBS=$ac_check_lib_save_LIBS
fi
echo "$as_me:$LINENO: result: $ac_cv_lib_vbisam_isopen" >&5
echo "${ECHO_T}$ac_cv_lib_vbisam_isopen" >&6
if test $ac_cv_lib_vbisam_isopen = yes; then
...
_ACEOF
    ...
    { { echo "$as_me:$LINENO: error: VB-ISAM library vbisam not found... aborting" >&5
echo "$as_me: error: VB-ISAM library vbisam not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
...
# Check whether --with-with-libdb or --without-with-libdb was given.
if test "${with_with_libdb+set}" = set; then
  withval="$with_with_libdb"
...
if test "x$with_libdb" != "x"; then
  ...
  then
     { { echo "$as_me:$LINENO: error: invalid library db option selected... aborting" >&5
echo "$as_me: error: invalid library db option selected... aborting" >&2;}
   { (exit 1); exit 1; }; }
  else
 ...
 db_header="101"
  ...
  db_header="0"
   ...
   if test "x$with_libdb" = "x1" &&
      test "$db_header" = "0"
   then
      { { echo "$as_me:$LINENO: error: header for library db version 1.x not found... aborting" >&5
echo "$as_me: error: header for library db version 1.x not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
   fi
   if test "$db_header" = "100"
   then
...
_ACEOF
 db_header="2"
  ...
  { { echo "$as_me:$LINENO: error: header db2/db_185.h for library db version 2.x not found... aborting" >&5
echo "$as_me: error: header db2/db_185.h for library db version 2.x not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
...
_ACEOF
 db_header="3"
  ...
  { { echo "$as_me:$LINENO: error: header db3/db_185.h for library db version 3.x not found... aborting" >&5
echo "$as_me: error: header db3/db_185.h for library db version 3.x not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
...
for ac_header in "db4.1/db_185.h"
do
as_ac_Header=`echo "ac_cv_header_$ac_header" | $as_tr_sh`
if eval "test \"\${$as_ac_Header+set}\" = set"; then
  echo "$as_me:$LINENO: checking for $ac_header" >&5
...
for ac_header in "db4.2/db_185.h"
do
as_ac_Header=`echo "ac_cv_header_$ac_header" | $as_tr_sh`
if eval "test \"\${$as_ac_Header+set}\" = set"; then
  echo "$as_me:$LINENO: checking for $ac_header" >&5
...
for ac_header in "db4.3/db_185.h"
do
as_ac_Header=`echo "ac_cv_header_$ac_header" | $as_tr_sh`
if eval "test \"\${$as_ac_Header+set}\" = set"; then
  echo "$as_me:$LINENO: checking for $ac_header" >&5
...
for ac_header in "db4.4/db_185.h"
do
as_ac_Header=`echo "ac_cv_header_$ac_header" | $as_tr_sh`
if eval "test \"\${$as_ac_Header+set}\" = set"; then
  echo "$as_me:$LINENO: checking for $ac_header" >&5
...
for ac_header in "db4.5/db_185.h"
do
as_ac_Header=`echo "ac_cv_header_$ac_header" | $as_tr_sh`
if eval "test \"\${$as_ac_Header+set}\" = set"; then
  echo "$as_me:$LINENO: checking for $ac_header" >&5
...
for ac_header in "db46/db_185.h"
do
as_ac_Header=`echo "ac_cv_header_$ac_header" | $as_tr_sh`
if eval "test \"\${$as_ac_Header+set}\" = set"; then
  echo "$as_me:$LINENO: checking for $ac_header" >&5
...
if test $db_header = "0"; then
   { { echo "$as_me:$LINENO: error: No header db_185.h for library db version 4.x not found... aborting" >&5
echo "$as_me: error: No header db_185.h for library db version 4.x not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
fi
fi
...
if test "${db_header}" = "0" ; then
   { { echo "$as_me:$LINENO: error: library headers (db.h or db_185.h) not found... aborting" >&5
echo "$as_me: error: library headers (db.h or db_185.h) not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
#else
...
if test "${db_header}" = "10" ; then
  ...
  echo "$as_me:$LINENO: checking if db.h header belongs to version 1.x" >&5
echo $ECHO_N "checking if db.h header belongs to version 1.x... $ECHO_C" >&6
  cat >conftest.$ac_ext <<_ACEOF
/* confdefs.h.  */
_ACEOF
cat confdefs.h >>conftest.$ac_ext
...
echo "${ECHO_T}yes" >&6
   ...
   echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6;
                   { { echo "$as_me:$LINENO: error: header db.h for library db version 1.x not found... aborting" >&5
echo "$as_me: error: header db.h for library db version 1.x not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
...
if test "${db_header}" = "1" ; then
  ...
  echo "$as_me:$LINENO: checking if db1/db.h header belongs to version 1.x" >&5
echo $ECHO_N "checking if db1/db.h header belongs to version 1.x... $ECHO_C" >&6
  cat >conftest.$ac_ext <<_ACEOF
/* confdefs.h.  */
_ACEOF
cat confdefs.h >>conftest.$ac_ext
...
#  echo -n "checking for -ldb2 (with 1.85 API compatibility)..."
  echo "$as_me:$LINENO: checking for -ldb2 with 1.85 API compatibility" >&5
echo $ECHO_N "checking for -ldb2 with 1.85 API compatibility... $ECHO_C" >&6
  LIBS="-ldb2"
cat >conftest.$ac_ext <<_ACEOF
/* confdefs.h.  */
_ACEOF
...
cat >>conftest.$ac_ext <<_ACEOF
/* end confdefs.h.  */
#define DB_LIBRARY_COMPATIBILITY_API 1
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="2"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5

 echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6;  db_header="21"
...
#  echo -n "checking for -ldb-3 (with 1.85 API compatibility)..."
  echo "$as_me:$LINENO: checking for -ldb-3 with 1.85 API compatibility" >&5
echo $ECHO_N "checking for -ldb-3 with 1.85 API compatibility... $ECHO_C" >&6
  LIBS="-ldb-3"
#  LIBS="$LIBS_BK -ldb-3"
#  INCLUDES="$INCLUDES_BK"
cat >conftest.$ac_ext <<_ACEOF
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="3"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5

 echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6;  db_header="32"
...
#  echo -n "checking for -ldb3 (with 1.85 API compatibility)..."
  echo "$as_me:$LINENO: checking for -ldb3 with 1.85 API compatibility" >&5
echo $ECHO_N "checking for -ldb3 with 1.85 API compatibility... $ECHO_C" >&6
  LIBS="-ldb3"
#  LIBS="$LIBS_BK -ldb3"
#  INCLUDES="$INCLUDES_BK"
cat >conftest.$ac_ext <<_ACEOF
...
#  echo -n "checking for -ldb-4 (with 1.85 API compatibility)..."
  echo "$as_me:$LINENO: checking for -ldb-4 with 1.85 API compatibility" >&5
echo $ECHO_N "checking for -ldb-4 with 1.85 API compatibility... $ECHO_C" >&6
  LIBS="-ldb-4"
#  LIBS="$LIBS_BK -ldb-4"
#  INCLUDES="$INCLUDES_BK"
cat >conftest.$ac_ext <<_ACEOF
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="4"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5

 echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6;  db_header="41"
...
#  echo -n "checking for -ldb-4.1 (with 1.85 API compatibility)..."
  echo "$as_me:$LINENO: checking for -ldb-4.1 with 1.85 API compatibility" >&5
echo $ECHO_N "checking for -ldb-4.1 with 1.85 API compatibility... $ECHO_C" >&6
  LIBS="-ldb-4.1"
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="41"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5

 echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6;  db_header="42"
...
#  echo -n "checking for -ldb-4.2 (with 1.85 API compatibility)..."
  echo "$as_me:$LINENO: checking for -ldb-4.2 with 1.85 API compatibility" >&5
echo $ECHO_N "checking for -ldb-4.2 with 1.85 API compatibility... $ECHO_C" >&6
  LIBS="-ldb-4.2"
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="42"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5

 echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6;  db_header="43"
...
#  echo -n "checking for -ldb-4.3 (with 1.85 API compatibility)..."
  echo "$as_me:$LINENO: checking for -ldb-4.3 with 1.85 API compatibility" >&5
echo $ECHO_N "checking for -ldb-4.3 with 1.85 API compatibility... $ECHO_C" >&6
  LIBS="-ldb-4.3"
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="43"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5

 echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6;  db_header="44"
...
#  echo -n "checking for -ldb-4.4 (with 1.85 API compatibility)..."
  echo "$as_me:$LINENO: checking for -ldb-4.4 with 1.85 API compatibility" >&5
echo $ECHO_N "checking for -ldb-4.4 with 1.85 API compatibility... $ECHO_C" >&6
  LIBS="-ldb-4.4"
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="44"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5

 echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6;  db_header="45"
...
#  echo -n "checking for -ldb-4.5 (with 1.85 API compatibility)..."
  echo "$as_me:$LINENO: checking for -ldb-4.5 with 1.85 API compatibility" >&5
echo $ECHO_N "checking for -ldb-4.5 with 1.85 API compatibility... $ECHO_C" >&6
  LIBS="-ldb-4.5"
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="45"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5

 echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6;  db_header="46"
...
#  echo -n "checking for -ldb-4.6 (with 1.85 API compatibility)..."
  echo "$as_me:$LINENO: checking for -ldb-4.6 with 1.85 API compatibility" >&5
echo $ECHO_N "checking for -ldb-4.6 with 1.85 API compatibility... $ECHO_C" >&6
  LIBS="-ldb-4.6"
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="46"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5
...
#  echo -n "checking for -ldb (versions 2.x 3.x 4.x with 1.85 API compatibility)..."
  echo "$as_me:$LINENO: checking for -ldb versions 2.x 3.x 4.x with 1.85 API compatibility" >&5
echo $ECHO_N "checking for -ldb versions 2.x 3.x 4.x with 1.85 API compatibility... $ECHO_C" >&6
  LIBS="-ldb"
#  LIBS="$LIBS_BK -ldb"
#  INCLUDES="$INCLUDES_BK"
cat >conftest.$ac_ext <<_ACEOF
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="23"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="32"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5

 echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6;  db_header="123"
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="123"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5

 echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6; { { echo "$as_me:$LINENO: error: library test link failed for db3 or db2 and/or compatibility API to version 1.85 not found... aborting" >&5
echo "$as_me: error: library test link failed for db3 or db2 and/or compatibility API to version 1.85 not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
...
#  echo -n "checking for -ldb (version 3.x with 1.85 API compatibility)..."
  echo "$as_me:$LINENO: checking for -ldb version 3.x with 1.85 API compatibility" >&5
echo $ECHO_N "checking for -ldb version 3.x with 1.85 API compatibility... $ECHO_C" >&6
  LIBS="-ldb"
#  LIBS="$LIBS_BK -ldb"
#  INCLUDES="$INCLUDES_BK"
cat >conftest.$ac_ext <<_ACEOF
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="31"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5

 echo "$as_me:$LINENO: result: no" >&5
echo "${ECHO_T}no" >&6; { { echo "$as_me:$LINENO: error: library test link failed for db and/or compatibility API to version 1.85 not found... aborting" >&5
echo "$as_me: error: library test link failed for db and/or compatibility API to version 1.85 not found... aborting" >&2;}
   { (exit 1); exit 1; }; }
...
#  echo -n "checking for -ldb (version 2.x with 1.85 API compatibility)..."
  echo "$as_me:$LINENO: checking for -ldb version 2.x with 1.85 API compatibility" >&5
echo $ECHO_N "checking for -ldb version 2.x with 1.85 API compatibility... $ECHO_C" >&6
  LIBS="-ldb"
#  LIBS="$LIBS_BK -ldb"
#  INCLUDES="$INCLUDES_BK"
cat >conftest.$ac_ext <<_ACEOF
...
if { (eval echo "$as_me:$LINENO: \"$ac_link\"") >&5
  ...
  (exit $ac_status); }; }; then
   echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6; db_version="21"
else
  echo "$as_me: failed program was:" >&5
sed 's/^/| /' conftest.$ac_ext >&5
...
# Check whether --with-cobf2f or --without-cobf2f was given.
if test "${with_cobf2f+set}" = set; then
  withval="$with_cobf2f"
...
# Check whether --with-with-dash-redefine or --without-with-dash-redefine was given.
if test "${with_with_dash_redefine+set}" = set; then
  withval="$with_with_dash_redefine"
...
cat >>confdefs.h <<_ACEOF
#define TCOB_STR_DASH_REDEFINE "${tcob_str_dash_redefine}"
_ACEOF


cat >>confdefs.h <<_ACEOF
#define TCOB_CCX_CMD "${CC}"
_ACEOF
...
cat >>confdefs.h <<_ACEOF
#define TCOB_COB_CMD "${COB}"
_ACEOF


cat >>confdefs.h <<_ACEOF
#define TCOB_DEFAULTS_PATH "${tcob_default_config}"
_ACEOF
...
cat >>confdefs.h <<_ACEOF
#define TCOB_LD_PATHS_DEFAULT "${tcob_ld_paths_default}"
_ACEOF


cat >>confdefs.h <<_ACEOF
#define TCOB_LD_ARGS_MATH "$tcob_ld_args_m"
_ACEOF

cat >>confdefs.h <<_ACEOF
#define TCOB_LD_ARGS_HTCOBOL "$tcob_ld_args_htcobol"
_ACEOF

cat >>confdefs.h <<_ACEOF
#define TCOB_LD_ARGS_DB "$tcob_ld_args_db"
_ACEOF

cat >>confdefs.h <<_ACEOF
#define TCOB_LD_ARGS_ISAM "$tcob_ld_args_isam"
_ACEOF

cat >>confdefs.h <<_ACEOF
#define TCOB_LD_ARGS_CURSES "$tcob_ld_args_curses"
_ACEOF

cat >>confdefs.h <<_ACEOF
#define TCOB_LD_ARGS_READLINE "$tcob_ld_args_readline"
_ACEOF

cat >>confdefs.h <<_ACEOF
#define TCOB_LD_ARGS_DL "$tcob_ld_args_dl"
_ACEOF


cat >>confdefs.h <<_ACEOF
#define TCOB_SHLIB_EXT "$shared_lib_extension"
_ACEOF
...
cat >>confdefs.h <<_ACEOF
#define TCOB_LD_ARGS_DEFAULT "$tcob_ld_args_default"
_ACEOF


                                                                                                                                                                                              ac_config_files="$ac_config_files Makefile compiler/Makefile compiler/htversion.h compiler/htcobolrc lib/Makefile cobrun/Makefile cobrun/tcrunversion.h utils/Makefile utils/cobf2f/Makefile test.code/Makefile test.code/mconfig.inc test.code/copybooks/Makefile info/Makefile info/slackware/SlackBuild test_suite/Makefile test_suite/coboltest.inc test_suite/nist/makeConfig.inc test_suite/nist/Makefile lib/htcobolrt.rc"
...
do
  ...
  "compiler/htversion.h" ) CONFIG_FILES="$CONFIG_FILES compiler/htversion.h" ;;
  "compiler/htcobolrc" ) CONFIG_FILES="$CONFIG_FILES compiler/htcobolrc" ;;
  "lib/Makefile" ) CONFIG_FILES="$CONFIG_FILES lib/Makefile" ;;
  "cobrun/Makefile" ) CONFIG_FILES="$CONFIG_FILES cobrun/Makefile" ;;
  "cobrun/tcrunversion.h" ) CONFIG_FILES="$CONFIG_FILES cobrun/tcrunversion.h" ;;
  "utils/Makefile" ) CONFIG_FILES="$CONFIG_FILES utils/Makefile" ;;
  "utils/cobf2f/Makefile" ) CONFIG_FILES="$CONFIG_FILES utils/cobf2f/Makefile" ;;
  "test.code/Makefile" ) CONFIG_FILES="$CONFIG_FILES test.code/Makefile" ;;
  "test.code/mconfig.inc" ) CONFIG_FILES="$CONFIG_FILES test.code/mconfig.inc" ;;
  "test.code/copybooks/Makefile" ) CONFIG_FILES="$CONFIG_FILES test.code/copybooks/Makefile" ;;
  "info/Makefile" ) CONFIG_FILES="$CONFIG_FILES info/Makefile" ;;
  "info/slackware/SlackBuild" ) CONFIG_FILES="$CONFIG_FILES info/slackware/SlackBuild" ;;
  "test_suite/Makefile" ) CONFIG_FILES="$CONFIG_FILES test_suite/Makefile" ;;
  "test_suite/coboltest.inc" ) CONFIG_FILES="$CONFIG_FILES test_suite/coboltest.inc" ;;
  "test_suite/nist/makeConfig.inc" ) CONFIG_FILES="$CONFIG_FILES test_suite/nist/makeConfig.inc" ;;
  "test_suite/nist/Makefile" ) CONFIG_FILES="$CONFIG_FILES test_suite/nist/Makefile" ;;
  "lib/htcobolrt.rc" ) CONFIG_FILES="$CONFIG_FILES lib/htcobolrt.rc" ;;
  "htconfig.h" ) CONFIG_HEADERS="$CONFIG_HEADERS htconfig.h" ;;
...
s,@LEX@,$LEX,;t t
s,@YACC@,$YACC,;t t
s,@expand_cmd_path@,$expand_cmd_path,;t t
s,@CFLAGS@,$CFLAGS,;t t
...
s,@CCXFLAGS@,$CCXFLAGS,;t t
s,@ACXFLAGS@,$ACXFLAGS,;t t
s,@exeext@,$exeext,;t t
s,@tcob_default@,$tcob_default,;t t
s,@cobcpy_default@,$cobcpy_default,;t t
s,@yacc_prefix_compiler@,$yacc_prefix_compiler,;t t
s,@copybook_path@,$copybook_path,;t t
s,@tcob_docdir@,$tcob_docdir,;t t
s,@os_platform@,$os_platform,;t t
s,@TCOB_MAJOR_VERSION@,$TCOB_MAJOR_VERSION,;t t
s,@TCOB_MINOR_VERSION@,$TCOB_MINOR_VERSION,;t t
s,@TCOB_PATCH_LEVEL@,$TCOB_PATCH_LEVEL,;t t
s,@TCOB_VERSION@,$TCOB_VERSION,;t t
s,@TCOB_RELEASE_DATE@,$TCOB_RELEASE_DATE,;t t
s,@tcob_version@,$tcob_version,;t t
s,@prefix_local@,$prefix_local,;t t
s,@drive_prefix@,$drive_prefix,;t t
s,@TCOBRUN_MAJOR_VERSION@,$TCOBRUN_MAJOR_VERSION,;t t
s,@TCOBRUN_MINOR_VERSION@,$TCOBRUN_MINOR_VERSION,;t t
s,@TCOBRUN_PATCH_LEVEL@,$TCOBRUN_PATCH_LEVEL,;t t
s,@TCOBRUN_VERSION@,$TCOBRUN_VERSION,;t t
s,@TCOBRUN_RELEASE_DATE@,$TCOBRUN_RELEASE_DATE,;t t
s,@tcob_libs_opt@,$tcob_libs_opt,;t t
s,@tcob_libs_install_opt@,$tcob_libs_install_opt,;t t
s,@tcob_libs_uninstall_opt@,$tcob_libs_uninstall_opt,;t t
s,@tcob_cobrun_build_opt@,$tcob_cobrun_build_opt,;t t
s,@tcob_cobrun_name1_opt@,$tcob_cobrun_name1_opt,;t t
s,@tcob_cobrun_name2_opt@,$tcob_cobrun_name2_opt,;t t
s,@tcob_manfiles@,$tcob_manfiles,;t t
s,@tcob_htmlfiles@,$tcob_htmlfiles,;t t
s,@tcob_textfiles@,$tcob_textfiles,;t t
s,@tcob_intman@,$tcob_intman,;t t
s,@tcob_inthtml@,$tcob_inthtml,;t t
s,@tcob_inttext@,$tcob_inttext,;t t
s,@tcob_cobf2f_dir@,$tcob_cobf2f_dir,;t t
s,@tcob_cobf2f_dir1@,$tcob_cobf2f_dir1,;t t
s,@tcob_cobf2f_man@,$tcob_cobf2f_man,;t t
s,@tcob_cobf2f_html@,$tcob_cobf2f_html,;t t
s,@tcob_cobf2f_text@,$tcob_cobf2f_text,;t t
s,@tcob_cobf2f_intman@,$tcob_cobf2f_intman,;t t
s,@tcob_cobf2f_inthtml@,$tcob_cobf2f_inthtml,;t t
s,@tcob_cobf2f_inttext@,$tcob_cobf2f_inttext,;t t
s,@tcob_math_functions@,$tcob_math_functions,;t t
s,@tcob_ld_args_htcobol@,$tcob_ld_args_htcobol,;t t
s,@tcob_ld_args_m@,$tcob_ld_args_m,;t t
s,@tcob_ld_args_db@,$tcob_ld_args_db,;t t
s,@tcob_ld_args_isam@,$tcob_ld_args_isam,;t t
s,@tcob_ld_args_dl@,$tcob_ld_args_dl,;t t
s,@tcob_ld_args_curses@,$tcob_ld_args_curses,;t t
s,@tcob_ld_args_readline@,$tcob_ld_args_readline,;t t
s,@tcob_ld_paths_default@,$tcob_ld_paths_default,;t t
s,@tcob_ld_args_default@,$tcob_ld_args_default,;t t
s,@tcob_ld_args_defaults@,$tcob_ld_args_defaults,;t t
s,@asx_cmd@,$asx_cmd,;t t
s,@ccx_cmd@,$ccx_cmd,;t t
s,@ranlibx_cmd@,$ranlibx_cmd,;t t
s,@arx_cmd@,$arx_cmd,;t t
s,@tcob_lang@,$tcob_lang,;t t
